...
- Полноценные потоки с параллельным выполнением и асинхронным ожиданием на основе [машины Даффа](https://en.wikipedia.org/wiki/Duff%27s_device)
...
- Лёгкий вес: ядро занимает 500 Б флешки и 6 Б оперативки (AVR, отключены ID и события)
...
- v1.2.0 - крупное обновление, изменена логика вызова Setup и удаления задач
